...
public class JogoDaForca {
	...
	public void iniciar() {        //retorna o tamanho da palavra sorteada no momento
		int  palavras = palavras.size();
	}
	//realiza o sorteio de uma das palavras existentes na lista de palavras.
	public String getDica() {       //retorna a dica associada à palavra sorteada no momento.
		
	}
	
	public int getTamanho() {      //retorna o tamanho da palavra sorteada no momento
